...
const typographyVariants = cva([], {
  variants: {
    variant: {
      h1: "text-5xl font-extrabold leading-none text-balance",
      h2: "text-4xl font-semibold leading-none text-balance",
      h3: "text-3xl font-semibold leading-none text-balance",
